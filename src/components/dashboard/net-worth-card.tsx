...
export function NetWorthCard({ totalNetWorth, changePercentage = 0 }: NetWorthCardProps) {
    return (
        <div className="group relative overflow-hidden rounded-3xl bg-white p-6 shadow-sm transition-all hover:shadow-md dark:bg-slate-800 border border-border">
            ...
            <div className="relative z-10">
                <div className="flex items-start justify-between mb-4">
                    ...
                    <div className={cn(
                        "flex items-center gap-1 rounded-full px-3 py-1 text-sm font-semibold shrink-0",
                        changePercentage >= 0
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">Last updated just now</p>
            </div>
        </div>
    );
}
