...
export function AccountEditForm({ account, onSuccess, onCancel, isModal = false }: AccountEditFormProps) {
  ...
  const formContent = (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
        ...
        <div className="relative overflow-hidden p-6 rounded-[24px] bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} value={field.value}>
                  ...
                  <SelectContent className="rounded-[16px] p-2 border-slate-100 shadow-xl">
  ...
  if (isModal) {
    return (
      <div className="bg-white dark:bg-slate-900 rounded-[32px] overflow-hidden shadow-2xl">
        <div className="relative h-24 bg-slate-900 flex items-center px-6 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-24 h-24 bg-primary/20 rounded-full blur-2xl -ml-12 -mb-12" />
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-black text-white tracking-tight">Edit Portfolio</h2>
              <p className="text-slate-400 font-bold text-xs">Refine your account details</p>
            </div>
          </div>
        </div>
        <div className="p-6">
